...
function decodeWorkspaceName(dirName: string): string {
  // e.g. --home-claidler-- → /home/claidler
  // e.g. --home-claidler-workspace-budget-- → /home/claidler/workspace/budget
    ...
    for (const dir of workspaceDirs) {
      ...
      for (const file of files) {
        ...
        sessions.push({
          ...
          path: `${dir}/${file}`,
          workspace: decodeWorkspaceName(dir),
          model: 'pi-agent',
          status: 'idle',
          createdAt: timestamp || ''
        });
